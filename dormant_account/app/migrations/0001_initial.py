    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lastLogin', models.DateTimeField(blank=True, default=datetime.datetime(2019, 8, 21, 1, 48, 51, 872436, tzinfo=utc))),
                ('dormantDate', models.DateTimeField(default=django.utils.timezone.now)),
                ('deleteDate', models.DateTimeField(blank=True, default=datetime.datetime(2019, 8, 21, 1, 48, 51, 872436, tzinfo=utc))),
